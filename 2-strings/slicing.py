...
"""
! category : medium
TODO : The instructions ask you to create a program that works with the string : text = "Data_Science_and_Machine_Learning_2023". Your program needs to use string slicing to : 1. Extract the word "Science" (characters 5 to 11), 2. Extract the word "Machine" (using negative indices), 3. Reverse the order of the word "Learning" (using proper indices), 4. Take every third character from the entire string (indices 0, 3, 6, etc.), 5. Take the last 4 characters and combine them with the first 4 characters in one variable
"""
