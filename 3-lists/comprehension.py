"""
! category : easy
TODO : You have a list containing student data in the form of dictionaries. Each dictionary contains information about the student's name and score. Create a program that uses list comprehension to: 1. Create a new list containing only the names of students with scores above 70, 2. Create a new list containing the pass/fail status, for each student (pass if score ≥ 60), 3. Create a new list containing uppercase names for students with scores above 80. Initial Data: students = [{"name": "John", "score": 85}, {"name": "Alice", "score": 72}, {"name": "Bob", "score": 58}, {"name": "Carol", "score": 95}, {"name": "David", "score": 69}, {"name": "Emma", "score": 81}]
"""
...
"""
! category : medium
TODO : You have a list containing product data in the form of tuples. Each tuple contains information about the product name, category, price, and stock. Create a program that uses list comprehension to: 1. Create list of product names, 2. Create list of (product_name, price) tuples, 3. Create list of names for available products (stock > 0) with price < 50000, 4. Create list of total inventory values (price × stock), 5. Create nested list grouping product names by category. Initial Data: products = [("Laptop", "Electronics", 15000000, 5), ("Smartphone", "Electronics", 8000000, 10), ("T-shirt", "Clothing", 45000, 20), ("Coffee Maker", "Kitchen", 850000, 3), ("Jeans", "Clothing", 150000, 0), ("Headphones", "Electronics", 350000, 8), ("Mug", "Kitchen", 25000, 15), ("Socks", "Clothing", 15000, 25)]
"""
